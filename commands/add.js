...
module.exports = {
	...
	description: 'Add an account to stock.', // Command description displays in the help command
	...
	execute(message, args) {
        ...
        if (!service) {
            return message.channel.send(
                ...
                .setDescription('Please specify which stock you have to generate')
                .addField('For example', `${config.prefix}${this.name} **minecraft**`)
        ...
        fs.appendFile(filePath, `${os.EOL}${args[1]}`, function (error) {
            ...
            message.channel.send(
                ...
                .setDescription(`Successfuly added \`${args[1]}\` stock to \`${args[0]}\` item`)
